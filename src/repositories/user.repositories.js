        ...
        db.run(`
            ...
            `, [id], (err) => {
                if(err) {
                    ...
                    resolve({ message: "User deleted sucessfully", id })
                }
            })
    })
}
...
export default {
    createUserRepository, findUserByEmailRepository, findUserByIdRepository, findAllUserRepository, updateUserRepository, deleteUserRepository
};